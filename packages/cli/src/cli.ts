...
import { householdSpendingAction, householdBalanceAction, householdReportAction } from "./commands/household.js";
...
program.option("--profile <name>", "Use a named profile (session file)");
...
// Household commands
const householdCmd = program
  .command("household")
  .description("Combined household finance view (daniel + shelly)");

householdCmd
  .command("spending [month]")
  .description("Household spending breakdown across both accounts")
  .action(householdSpendingAction);

householdCmd
  .command("balance")
  .description("Household balances for both accounts")
  .action(householdBalanceAction);

householdCmd
  .command("report [month]")
  .description("Full household report: spending + balances")
  .action(householdReportAction);
